...
// *********************************************************************
  ...
  // global defines
  #define encoder_A_pin       6    // physical pin has to be 2 or 3 to use interrupts (on mega e.g. 20 or 21), use internal pullups
  #define encoder_B_pin       7    // physical pin has to be 2 or 3 to use interrupts (on mega e.g. 20 or 21), use internal pullups
  #define encoder_button_pin  8    // physical pin , use internal pullup
...
void lcdml_menu_control(void)
{
  ...
  if(key)  // Check for a valid key.
  {
    switch (key)
    {
      ...
      case '4': LCDML.CE_set(5); LCD
      
      ML.BT_left();  break;
      case '5': LCDML.CE_set(6);0177 break; 
